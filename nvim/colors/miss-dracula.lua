...
local colors = {
    ...
    green = "#87E58E",
    grey = "#A9ABAC",
    grey_statusline = "#44475a",
    gutter_fg = "#4B5263",
    lavender = "#6272A4",
    lilac = "#6D5978",
    neon_cyan = "#00DFDF",
    -- orange = "#FFBFA9", -- #FB3669
    orange = "#D48A6A", -- Remplace #FFBFA9
    pink = "#E48CC1",
    purple = "#BAA0E8",
    red = "#E95678",
    selection = "#3C4148",
...
for name, color in pairs(mode_colors) do
    ...
    vim.api.nvim_set_hl(0, "StatuslineModeSeparator" .. name, {
        fg = color,
        bg = colors.bg, -- ou transparent si tu veux
    })
    vim.api.nvim_set_hl(0, "StatuslineModeSeparatorOther", {
        fg = colors.grey,
...
local groups = {
    ...
    CurSearch = { fg = colors.white, bg = colors.fuchsia },
    ...
    -- === LOGO ===
    DashboardLogo = { fg = colors.bright_green, bold = true },
    ...
    -- StatusLine = { fg = colors.fg, bg = colors.grey_statusline },
    ...
    -- MiniPick
    MiniPickNormal = { fg = colors.fg, bg = colors.transparent_black },
    -- MiniPickBorder = { fg = colors.lavender, bg = colors.bg },
    -- MiniPickBorderBusy = { fg = colors.yellow, bg = colors.bg },
    -- MiniPickBorderText = { fg = colors.purple, bg = colors.bg, bold = true },
    -- MiniPickPrompt = { fg = colors.cyan, bg = colors.bg, bold = true },
    -- MiniPickPromptCaret = { fg = colors.fuchsia, bg = colors.bg },
    -- MiniPickPromptPrefix = { fg = colors.pink, bg = colors.bg, bold = true },
    -- MiniPickMatchCurrent = { fg = colors.green, bg = colors.selection, bold = true },
    -- MiniPickMatchMarked = { fg = colors.red, bg = colors.visual },
    MiniPickMatchRanges = { fg = colors.bright_green, bold = false, italic = true },
    -- MiniPickIconDirectory = { fg = colors.purple },
    MiniPickIconFile = { fg = colors.green },
    -- MiniPickPreviewLine = { bg = colors.selection },
    -- MiniPickPreviewRegion = { bg = colors.visual },
    -- MiniPickHeader = { fg = colors.yellow, bold = true },
