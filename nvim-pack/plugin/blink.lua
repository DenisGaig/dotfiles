...
add {
    ...
    { src = "Kaiser-Yang/blink-cmp-dictionary", setup = false },
    { src = 'saghen/blink.lib', setup = false },
    {
        ...
        local luasnip = require('luasnip')
            ...
            -- Charge les snippets friendly-snippets
            require('luasnip.loaders.from_vscode').lazy_load()

            -- Tes snippets perso (adapte le chemin vers nvim-pack)
            require('luasnip.loaders.from_lua').load({
                paths = vim.fn.expand('~/.dotfiles/nvim-pack/snippets'),
            })
